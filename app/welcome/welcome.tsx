  ...
  return (
    <main className="px-[clamp(8px,3vw,28px)] pt-3 pb-0">
      <section className="grid grid-cols-1 md:grid-cols-2 gap-[clamp(8px,1.8vw,20px)] min-h-[calc(100vh-65px-12px)]">
        ...
        <Link to="naiste" className="contents">
          <article className="relative min-h-full border border-[#2C1C0D] overflow-hidden cursor-pointer">
            <img
        ...
        <Link to="mees" className="contents">
          <article className="relative min-h-full border border-[#2C1C0D] overflow-hidden cursor-pointer">
            <img
